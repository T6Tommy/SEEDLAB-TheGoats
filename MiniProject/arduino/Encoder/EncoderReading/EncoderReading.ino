...
Encoder myEnc(2, 11); // Pin a from the motor is attached to digital pin 3, and pin b is attached to digital pin 4
int PWMpin=9;
...
void loop() {
  if (millis() > 1000 && millis() < 2000) analogWrite(PWMpin, 200);
